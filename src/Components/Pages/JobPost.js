...
export function Jobpost() {
  ...
  const handleSubmit =async () => {
    ...
    if (areAllFieldsFilled) {
      ...
      .then((res) => {
        console.log("job registration respons ",res.data);
  ...
  const validateForm = () => {
    for (const field in formData) {
      if (!formData[field]) {
        console.log(`alidation failed for field: ${field}`);
        return false;
      }
    }
    return true;
...
<p>facility type:</p>
            <select  name='facilityType' onChange={handleChange}  value={formData.facilityType} style={{border:"1px solid grey", textAlign:"left", padding:"5px",width:"320px",height:"40px"}} placeholder='enter facility' >
              ...
              <p>Remote:</p>
            <input  type='text' placeholder='Remote...'  value={formData.isRemote} onChange={handleChange} name='isRemote' style={{width:"330px"}}/>
            <p>Agreement Terms:</p>
            <input  type='text' placeholder='Agreement terms...'  value={formData.agreementTerms} onChange={handleChange} name="agreementTerms" style={{width:"330px"}}/>
            <p><b>Address:</b></p>
           

           <p>Street:</p>
           <input type="text" placeholder=" Enter Street Name.."   value={formData.street} onChange={handleChange}  name='street'
           required/>

           <p>City:</p>
            <input type="text"  placeholder="Enter City Name.."value={formData.city} onChange={handleChange}name="city"required />
            <p>Zip Code:</p>
            <input type="tel" placeholder="Enter Zip Code.." value={formData.doorNumber} onChange={handleChange} name="doorNumber" required/>
            <p>State:</p>
            <input type="text"  placeholder="Enter State.." value={formData.state} onChange={handleChange} name="state" required />
            <p>Landmark:</p>
            <input type="text"  placeholder="Enter Landmark.." value={formData.landmark} onChange={handleChange} name='landmark' required />
            <p><b>Duration:</b></p>
            <p>From Date*:</p>
            ...
            <p><b>Shifts:</b></p>
            <p>Hours*:</p>
            <input  type="number"  placeholder='enter hours' value={formData.hours}  onChange={handleChange}  name='hours'  required/>
            <p>Days of Week*:</p>
            <input  type="number" placeholder='days of week'   value={formData.daysOfWeek}  onChange={handleChange} name='daysOfWeek'   required/>
            <p><b>Scope of Practice:</b></p>
            <p>Description of Clinical Responsibilities*:</p>
            <input  type="text"  placeholder='enter Description of Clinical Responsibilities...' value={formData.clinicalResponsibilities}  name='clinicalResponsibilities' onChange={handleChange}    required/>
            <p>Description of Procedures*:</p>
            <input  type="text" placeholder=' enter Description of Procedures'   value={formData.procedures}  onChange={handleChange}  name='procedures'  required/>
            <p>Description of Services*:</p>
            <input  type="text" placeholder=' enter Description of  Services'   value={formData.services}  onChange={handleChange}  name='services'  required/>
            <p>Description of any other*:</p>
            <input  type="text" placeholder=' enter Description of  anyother'   value={formData.otherDescription}  onChange={handleChange} name='otherDescription'    required/>
            <p><b>Qualification:</b></p>
            <p>Notice*:</p>
            <input  type="number"  placeholder='enter notice...' value={formData.notice}  onChange={handleChange}   name='notice' required/>
            <p><b>Experience*:</b></p>
            <p>Years:</p>
            <input  type="number" placeholder='enter experience...' value={formData.experienceYears}  onChange={handleChange}  name='experienceYears'  required/>
            <p>Months:</p>
            <input  type="nuber" placeholder='enter months...' value={formData.experienceMonths}  onChange={handleChange}   name='experienceMonths' required/>

            <p><b>Support Staff*:</b></p>
            <p>Type:</p>
            <input  type="text" placeholder='enter type...' value={formData.supportStaffType}  onChange={handleChange}   name='supportStaffType' required/>
            <p>Numbers:</p>
            <input  type="text" placeholder='enter numbers...' value={formData.supportStaffNumber}  onChange={handleChange}  name='supportStaffNumber'  required/>
            <p><b>Compensation*:</b></p>
            <p>Hourly Rate:</p>
            <input  type="text" placeholder='enter Hourly rate...' value={formData.hourlyRate}  onChange={handleChange} name='hourlyRate'   required/>
            <p>Salary:</p>
            <input  type="text" placeholder='enter salary...' value={formData.salary}  onChange={handleChange}   name='salary' required/>

            <p><b>Credentialing*:</b></p>
            <p>Type:</p>
            <input  type="text" placeholder='enter  type...' value={formData.credentialingType}  onChange={handleChange}  name='credentialingType'  required/>
            <p>Description:</p>
            <input  type="text" placeholder='enter Description...' value={formData.credentialingDescription}  onChange={handleChange}  name='credentialingDescription'  required/>
            ...
            <p>Description:</p>
            <input  type="text" placeholder='enter Description...' value={formData.additionalRequirementDescription}  onChange={handleChange}  name='additionalRequirementDescription'    required/>
