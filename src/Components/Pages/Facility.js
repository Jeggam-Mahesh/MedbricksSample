      ...
      <div className='facility-reg'>
       ...
       <label htmlFor='name'>
           ...
           <label htmlFor='generalTerms'> <p className='para' >General Agreements Terms:</p></label>
            ...
            <label htmlFor='doorNumber'><p className='para'>Zip Code:</p></label>
            <input type="tel" id='doorNumber' placeholder="Enter Zip Code.." value={formData.zipcode} onChange={handleChange} name="zipcode" required/>
